 ...
 *
 *   node tools/cut.mjs key   <in> <out.png>
 *   node tools/cut.mjs fit   <in> <out.png> <W>x<H> [--palette P] [--no-quantise]
 *   node tools/cut.mjs trim  <in> <out.png> [--width N] [--pad N]
 *   node tools/cut.mjs web   <in> <out.webp> [--width N] [--q 0-100]
 *   node tools/cut.mjs anchors <in> [out.png] [--as WxH] [--tol N]
 *   node tools/cut.mjs slice <in> <outDir> <cell> [name,name,...]
 *   node tools/cut.mjs check <in> [--cell N] [--colours N] [--illustration]
 *
...
if (cmd === 'key') {
  ...
  console.log(`tools/cut.mjs — generated sheet -> cuttable game art
